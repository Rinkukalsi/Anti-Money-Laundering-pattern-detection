# -*- coding: utf-8 -*-
"""FormatData_AML.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17s3VgaWpMef_UmoapiVYMZqr7iO-AYLH
"""

!pip install datatable

"""###Encoding values in dataset"""
...
file1_path = '/content/drive/MyDrive/IBM/HI-Medium_Trans.csv'
file2_path = '/content/drive/MyDrive/IBM/Formattedtransactions/Formatted_HI-Medium_Trans.csv'

import dask.dataframe as dd

# Read CSV files using Dask
ddf1 = dd.read_csv(file1_path)
ddf2 = dd.read_csv(file2_path)

# Get lengths
len1 = len(ddf1)
len2 = len(ddf2)

# # Compute lengths (trigger computation)
# len1 = len1.compute()
# len2 = len2.compute()
...
if len1 == len2:
    ...
    print("The number of rows in the two files is different.")
...
inPath = "/content/drive/MyDrive/IBM/HI-Medium_Trans.csv"
outPath = "/content/drive/MyDrive/IBM/Formattedtransactions/Formatted_HI-Medium_Trans.csv"
...
67y7yprint("Currency Dictionary:")
for key, value in currency.items():
    print(f"{key}: {value}")

print("\nPayment Format Dictionary:")
for key, value in paymentFormat.items():
    print(f"{key}: {value}")
...
transaction_file = "/content/formatted_transactions.csv" #replace this with your path to the respective AML data objects
...
#number of days and transactions covered by the dataset
n_days = int(timestamps.max() / (3600 * 24) + 1)
n_samples = y.shape[0]
logging.info(f'number of days and transactions in the data: {n_days} days, {n_samples} transactions')

#iterating over each day log the below statistics
...
split_per = [0.6, 0.2, 0.2] #training split, val split and testing split
...
#Finalizing the split of data
tr_inds = torch.cat(split_inds[0])
val_inds = torch.cat(split_inds[1])
te_inds = torch.cat(split_inds[2])

#Logging information about the distribution of samples and illicit ratio for each set
